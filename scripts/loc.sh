...
py_file_count=$(find . -type f -name '*.py' -not -path '*/venv/*' -not -path '*/venv_pred_server/*' -not -path '*/quantstats_lumi/*' -not -path '*/node_modules/*' -not -path '*/build/*' -not -path "*/.mypy_cache/*" -not -path "*/binaries/*" | wc -l)
...
py_lines=$(find . -type f -name '*.py' -not -path '*/venv/*' -not -path '*/venv_pred_server/*' -not -path '*/node_modules/*' -not -path '*/quantstats_lumi/*' -not -path '*/build/*' -not -path "*/.mypy_cache/*" -not -path "*/binaries/*" | xargs cat | wc -l)
