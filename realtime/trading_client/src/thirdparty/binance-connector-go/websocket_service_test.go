...
func (s *websocketTestSuite) testWsUserDataServe(data []byte, expectedEvent *WsUserDataEvent) {
	...
	doneC, stopC, err := websocketStreamClient.WsUserDataServe(
		"listenKey",
		func(event *WsUserDataEvent) {
...
func (s *websocketTestSuite) TestWsAllMarketMiniTickersStatServe() {
	...
	doneC, stopC, err := websocketStreamClient.WsAllMarketMiniTickersStatServe(
...
func (s *websocketTestSuite) assertWsAllMarketMiniTickersStatEventEqual(
	e, a WsAllMarketMiniTickersStatEvent,
) {
	for i := range e {
...
func (s *websocketTestSuite) TestBookTickerServe() {
	...
	doneC, stopC, err := websocketStreamClient.WsBookTickerServe(
		"BTCUSD_200626",
...
func (s *websocketTestSuite) TestKlineServe() {
	...
	doneC, stopC, err := websocketStreamClient.WsKlineServe(
		"ETHBTC",
		"1m",
		func(event *WsKlineEvent) {
			e := &WsKlineEvent{
				Event:  "kline",
				Time:   1499404907056,
				Symbol: "ETHBTC",
...
func (s *websocketTestSuite) TestWsAggTradeServe() {
	...
	doneC, stopC, err := websocketStreamClient.WsAggTradeServe(
		"ETHBTC",
...
func (s *websocketTestSuite) TestWsAllMarketTickersStatServe() {
	...
	doneC, stopC, err := websocketStreamClient.WsAllMarketTickersStatServe(
		func(event WsAllMarketTickersStatEvent) {
...
func (s *websocketTestSuite) assertWsAllMarketTickersStatEventEqual(
	e, a WsAllMarketTickersStatEvent,
) {
	for i := range e {
